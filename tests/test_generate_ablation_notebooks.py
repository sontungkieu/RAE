    ...
    def test_generator_writes_selected_notebooks_and_manifest(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual([path.name for path in notebook_paths], [
                "01-moe1-m4-tau2-vk1.ipynb",
                "03-moe1-m6-tau4-vk01-hc96.ipynb",
            ])
            ...
            self.assertIn("--output /kaggle/working/celeba256_source_gmm_03_moe1_m6_tau4_vk01_hc96.npz", build_cell)
            self.assertIn("--num-modes 6", build_cell)
            self.assertIn('run_slug="03-moe1-m6-tau4-vk01-hc96"', train_cell)
