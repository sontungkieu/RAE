...
- `src_jax/build_source_gmm.py` encodes CelebA-HQ images with the frozen RAE, flattens the resulting `NHWC` latent tensor, and fits the offline diagonal GMM artifact consumed by the learned-source `moe1` path.
