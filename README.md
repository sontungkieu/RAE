...
- `vaes-jax-celebahq-kaggle-tpuv5e8-sitb-moe1-resume.ipynb` mirrors the resume-only Kaggle TPU pattern for the latest `CelebAHQ256_SiT-B_StabilityVAE_moe1_jax_tpuv5e8-*` Orbax workdir.
