...
- [vaes-jax-celebahq-kaggle-moe1.ipynb](vaes-jax-celebahq-kaggle-moe1.ipynb): Kaggle notebook for the backend-native `StabilityVAE + SiT-B + moe1` CelebA-HQ flow, including the same offline `src_jax/build_source_gmm.py` step and generated `source.enabled=true` config
