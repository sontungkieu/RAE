...
- [Kaggle TPU Notebook (StabilityVAE + SiT-B Resume)](../vaes-jax-celebahq-kaggle-tpuv5e8-sitb-resume.ipynb): resume-only `TPU v5e-8` notebook for the newest `CelebAHQ256_SiT-B_StabilityVAE_jax_tpuv5e8-*` workdir.
