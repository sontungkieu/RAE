...
- [Kaggle TPU Notebook (SiTDH-B Resume, CelebA-HQ)](../raes-jax-celebahq-kaggle-tpuv5e8-sitdh-b-resume.ipynb): resume-only `TPU v5e-8` notebook for the newest `CelebAHQ256_SiTDH-B_DINOv2-B_jax_tpuv5e8-*` workdir with the same fresh-workdir, fresh-W&B-run resume flow.
