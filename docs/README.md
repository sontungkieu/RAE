...
- [Kaggle Notebook (StabilityVAE + SiT-B + moe1, CelebA-HQ)](../vaes-jax-celebahq-kaggle-moe1.ipynb): end-to-end CelebA-HQ notebook for the same learned-source VAE flow.
