...
\begin{itemize}[leftmargin=1.5em]
  ...
  \texttt{CelebA256\_SiT-B\_StabilityVAE\_jax\_tpuv5e8-*} mới nhất và ép lại
  cả cấu hình \texttt{num\_workers=16}, \texttt{prefetch\_factor=4}, và hai
  cờ log diagnostics khi resume.
