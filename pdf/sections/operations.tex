...
\begin{itemize}[leftmargin=1.5em]
  ...
  về \texttt{16384} chiều trước khi fit GMM; chỉ khi thật sự thiếu RAM mới nên
  ép xuống \texttt{spatial\_mean},
  ...
  \texttt{raes-jax-celeba-kaggle-tpuv5e8-sitdh-s-moe1.ipynb}; bản này cố định biến
