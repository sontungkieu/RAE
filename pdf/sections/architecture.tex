...
\texttt{src\_jax/config\_adapter.py} & Chuyển YAML OmegaConf của repo sang config backend NNX, map \texttt{SiT}/\texttt{SiTDH}/\texttt{StabilityVAE} sang backend phù hợp, forward \texttt{random\_flip} / prefetch knobs, và mặc định bật flip cho config train CelebA-HQ \\
