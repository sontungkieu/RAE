...
\begin{itemize}[leftmargin=1.5em]
  ...
  \texttt{var\_kl\_loss\_weight}: trọng số auxiliary losses phía source. Mặc
  định branch này để \texttt{entropy\_loss\_weight=0.0} để không vô tình đẩy
  router về uniform, còn \texttt{var\_kl\_loss\_weight=1.0e-2} để khóa
  variance của source sát mục tiêu hơn;
