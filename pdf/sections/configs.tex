...
\begin{itemize}[leftmargin=1.5em]
  ...
  ma trận \texttt{N x D} kiểu \texttt{float32} và standardize in-place, nên
  full latent vector không còn cần memmap trên đĩa chỉ để né thêm bản copy
  RAM. Khi cần feature nén có cấu trúc hơn thì vẫn có thể ép
