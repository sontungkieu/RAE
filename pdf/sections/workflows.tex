...
Nếu muốn dùng baseline VAE mới, bắt đầu từ notebook
\texttt{vaes-jax-celeba-kaggle-moe1.ipynb}. Notebook này giữ nguyên flow
\texttt{uv sync} của Kaggle, nhưng chuẩn bị \texttt{celeba256\_imgfolder}, đổi
Stage 1 sang \texttt{stage1.StabilityVAE}, Stage 2 sang single-tower
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item cell train cuối truyền \texttt{--data-path /kaggle/working/celeba256\_imgfolder/train},
...
Branch này cũng giữ song song bộ notebook CelebA-HQ cho flow \texttt{moe1}:
\texttt{vaes-jax-celebahq-kaggle-moe1.ipynb},
