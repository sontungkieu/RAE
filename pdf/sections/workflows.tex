...
session cũ sẽ không bị giữ lại sai lịch sử. Sau mỗi lần save Orbax thành công,
runtime cũng sẽ prune các thư mục \texttt{checkpoint\_*} cũ trong workdir để
chỉ giữ lại checkpoint mới nhất cho lần resume sau. Nếu resume một Orbax workdir cũ chưa có
