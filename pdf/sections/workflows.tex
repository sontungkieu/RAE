...
đường low-copy: preallocate đúng một ma trận \texttt{N x D} \texttt{float32}
và standardize in-place, nên full latent vector không còn cần memmap trên đĩa
chỉ để né thêm bản copy RAM. Nếu muốn bản nén có cấu trúc hơn thì vẫn có thể
ép \texttt{pyramid\_16k}; \texttt{spatial\_mean} tiếp tục là fallback tiết kiệm
bộ nhớ khi máy không đủ RAM.
