...
\texttt{float32}. Nhờ vậy full latent vector không còn bắt buộc phải ở
\texttt{float32} toàn cục chỉ để fit GMM. Nếu muốn bản nén có cấu trúc hơn thì
vẫn có thể ép \texttt{pyramid\_16k}; \texttt{spatial\_mean} tiếp tục là
fallback tiết kiệm bộ nhớ khi máy không đủ RAM.
