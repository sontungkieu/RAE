...
\texttt{vaes-jax-celeba-kaggle.ipynb}. Notebook này giữ nguyên flow
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \texttt{--data-path /kaggle/working/celeba256\_imgfolder/train}, còn
...
Branch này cũng giữ song song bộ notebook CelebA-HQ:
\texttt{vaes-jax-celebahq-kaggle.ipynb},
